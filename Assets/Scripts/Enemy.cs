...
public class Enemy : MonoBehaviour
{
    ...
    {
        shotCounter -= Time.deltaTime; //for however long our frame takes in time
    ...
    private void Fire()
    {
        ...
        laser.GetComponent<Rigidbody2D>().velocity = new Vector2(0, -projectileSpeed); //make negative projectile speed, because want to be coming from top to bottom
